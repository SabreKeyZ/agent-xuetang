...
日历第 3 周前半 [vibe](../weeks/vibe.md) 可以多一句：`我用助手从空目录搭过带引用和人确认闸门的工单台，并自己验过 diff`。第 4 周最先 [vibe-claim](../weeks/vibe-claim.md) 再补一句：`迷你理赔台也是助手搭的，条款引用 + 人确认闸门，假引用我拒过`。不要把第 3 周后半 / 第 4 周中段现成源码说成自己手写。
