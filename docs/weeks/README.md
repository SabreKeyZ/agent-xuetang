...
默认路径：**8 周 · 每周 5–6 小时 · 合计约 43 小时**。
节奏：两个工作日晚上各 1.5 小时 + 一个周末块 2–3 小时。
不要跳周。做不完就停在当周验收标准。

读者是有基础的小白。还不会 Python：先看 [ROADMAP.md](../ROADMAP.md) 的 Week -1，再从日历周 1 开始。

| 日历周 | 小时 | 文档 | 工作日 / 周末怎么拆 |
| --- | --- | --- | --- |
| 1 | 3 | [00 环境](00-setup.md) | 两晚各 1.5h，或周末一次做完 |
| 2 | 5 | [01 循环](01-what-is-an-agent.md) | 两晚 1.5+1.5，周末 2h 改工具 |
| 3 | 6 | [02 ReAct](02-tools-and-react.md) | 两晚 1.5+1.5，周末 3h 评测 |
