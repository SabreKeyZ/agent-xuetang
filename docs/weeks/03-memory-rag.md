...
> **本班属于 1 个月路径的第 2 周**（前半，约 day 1–2）。同周还有 [04](04-mcp-and-skills.md)、[05](05-multi-agent.md)。
...
本班约 3 小时（一两个晚上）。读文档 0.5–1 小时；跑检索 1 小时；加一条「必须引用」的测试 0.5–1 小时。视频晚上当背景。同周三班合计约 8–10 小时。
