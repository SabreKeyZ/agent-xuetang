...
> **本班属于 1 个月路径的第 1 周**（后半：工具/ReAct，周末）。同周前半是 [00](00-setup.md)、[01](01-what-is-an-agent.md)。
...
本班约 3–4 小时（周末一块）。读 + 跑 1.5 小时；读懂解析器 0.5–1 小时；改评测或加第四条用例 0.5 小时。视频晚上当背景，不另开一天。同周三班合计约 8–10 小时。
