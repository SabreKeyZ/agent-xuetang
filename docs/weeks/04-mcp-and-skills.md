...
> **本班属于 1 个月路径的第 2 周**（中段，约 day 3–4）。同周还有 [03](03-memory-rag.md)、[05](05-multi-agent.md)。
...
本班约 3 小时（一两个晚上）。读 + 画图 0.5 小时；跑服务器 1.5 小时；写 Skill 和权限句 0.5–1 小时。MCP for Beginners 当目录翻，不另开一天。同周三班合计约 8–10 小时。
