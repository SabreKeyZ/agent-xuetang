...
> **本班属于 1 个月路径的第 1 周**（中段：循环）。同周前半是 [00](00-setup.md)，后半是 [02](02-tools-and-react.md)。
...
本班约 3 小时（一个晚上 + 一点缓冲）。读本文 + 跑脚本 1.5 小时；改一个新工具 0.5–1 小时；对着日志讲 0.5 小时。同周三班合计约 8–10 小时。
